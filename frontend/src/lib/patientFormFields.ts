...
export const patientFormSections: PatientFormSection[] = [
  {
    ...
    fields: [
      ...
      { name: "profession", labelKey: "profession", type: "text" },
      {
        ...
        type: "select",
        options: [
          { value: "celibataire", labelKey: "maritalStatusCelibataire" },
          { value: "marie", labelKey: "maritalStatusMarie" },
          { value: "divorce", labelKey: "maritalStatusDivorce" },
          { value: "veuf", labelKey: "maritalStatusVeuf" },
        ],
      },
      {
        name: "idDocumentType",
        ...
        options: [
          ...
          { value: "anip", labelKey: "idDocumentTypeAnip" },
          { value: "autre", labelKey: "idDocumentTypeAutre" },
        ],
      },
      { name: "idDocumentTypeOther", labelKey: "idDocumentTypeOtherPlaceholder", type: "text" },
  ...
  },
  {
    ...
    fields: [
      { name: "emergencyContact.name", labelKey: "emergencyContactName", type: "text", required: true },
      {
        ...
        labelKey: "emergencyContactRelation",
        type: "select",
        required: true,
        options: [
          { value: "epoux", labelKey: "emergencyContactRelationEpoux" },
          { value: "epouse", labelKey: "emergencyContactRelationEpouse" },
          { value: "parent", labelKey: "emergencyContactRelationParent" },
          { value: "enfant", labelKey: "emergencyContactRelationEnfant" },
          { value: "autre", labelKey: "emergencyContactRelationAutre" },
        ],
      },
      { name: "emergencyContact.relationOther", labelKey: "emergencyContactRelationOtherPlaceholder", type: "text" },
      ...
      { name: "emergencyContact.isPriority", labelKey: "emergencyContactIsPriority", type: "checkbox" },
    ],
  },
  {
    key: "medical",
    ...
    fields: [
      {
        ...
        options: [
          ...
          { value: "O+", labelKey: "O+" },
          { value: "O-", labelKey: "O-" },
          { value: "non_renseigne", labelKey: "bloodGroupNonRenseigne" },
        ],
      },
      {
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "insuranceNumber", labelKey: "insuranceNumber", type: "text" },
      {
        ...
        labelKey: "financiallyResponsible",
        type: "select",
        options: [
          { value: "patient", labelKey: "financiallyResponsiblePatient" },
          { value: "parent", labelKey: "financiallyResponsibleParent" },
          { value: "epoux_epouse", labelKey: "financiallyResponsibleSpouse" },
          { value: "autre", labelKey: "financiallyResponsibleAutre" },
        ],
      },
    ],
  },
  {
    ...
    fields: [
      ...
      {
        name: "pediatricInfo.legalGuardian",
        labelKey: "pediatricLegalGuardian",
        type: "select",
        options: [
          { value: "pere", labelKey: "guardianOptionPere" },
          { value: "mere", labelKey: "guardianOptionMere" },
          { value: "tuteur", labelKey: "guardianOptionTuteur" },
          { value: "autre", labelKey: "guardianOptionAutre" },
        ],
      },
      { name: "pediatricInfo.guardianPhone", labelKey: "pediatricGuardianPhone", type: "text" },
      {
        name: "pediatricInfo.guardianRelation",
        labelKey: "pediatricGuardianRelation",
        type: "select",
        options: [
          { value: "pere", labelKey: "guardianOptionPere" },
          { value: "mere", labelKey: "guardianOptionMere" },
      ...
      { name: "pediatricInfo.guardianRelationOther", labelKey: "guardianRelationOtherPlaceholder", type: "text" },
