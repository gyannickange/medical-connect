...
export const carePlan: TranslationSection = {
  en: {
    ...
    vitalsTargetLabel: "Expected target (< 140/90)",
    vitalsTrendImproving: "Improving",
    vitalsTrendWorsening: "Worsening",
    vitalsTrendStable: "Stable",
  ...
  fr: {
    ...
    vitalsTargetLabel: "Cible attendue (< 140/90)",
    vitalsTrendImproving: "Amélioration",
    vitalsTrendWorsening: "Aggravation",
    vitalsTrendStable: "Stable",
