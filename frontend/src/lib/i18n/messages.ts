...
export const messages: TranslationSection = {
  en: {
    ...
    staffPageSubtitle: "Manage the establishment's user accounts",
    activeUsersStatLabel: "Active users",
    suspendedStatLabel: "Suspended",
    rolesDefinedStatLabel: "Roles defined",
    servicesStatLabel: "Services",
    roleFilterLabel: "Role:",
    statusFilterLabelShort: "Status:",
    allLabel: "All",
    archiveStaffMember: "Archive Staff Member",
    confirmArchiveStaff: "Are you sure you want to archive",
    staffArchivedSuccessfully: "Staff member archived successfully",
    failedToArchiveStaff: "Failed to archive staff member",
    reactivateStaffMember: "Reactivate Staff Member",
    confirmReactivateStaff: "Are you sure you want to reactivate",
    staffReactivatedSuccessfully: "Staff member reactivated successfully",
    failedToReactivateStaff: "Failed to reactivate staff member",
  ...
  fr: {
    ...
    staffPageSubtitle: "Gestion des comptes utilisateurs de l'établissement",
    activeUsersStatLabel: "Utilisateurs actifs",
    suspendedStatLabel: "Suspendus",
    rolesDefinedStatLabel: "Rôles définis",
    servicesStatLabel: "Services",
    roleFilterLabel: "Rôle :",
    statusFilterLabelShort: "Statut :",
    allLabel: "Tous",
    archiveStaffMember: "Archiver le membre",
    confirmArchiveStaff: "Voulez-vous vraiment archiver",
    staffArchivedSuccessfully: "Membre du personnel archivé avec succès",
    failedToArchiveStaff: "Échec de l'archivage du membre du personnel",
    reactivateStaffMember: "Réactiver le membre",
    confirmReactivateStaff: "Voulez-vous vraiment réactiver",
    staffReactivatedSuccessfully: "Membre du personnel réactivé avec succès",
    failedToReactivateStaff: "Échec de la réactivation du membre du personnel",
