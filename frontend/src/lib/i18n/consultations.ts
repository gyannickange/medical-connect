...
export const consultations: TranslationSection = {
  en: {
    ...
    consultationsArchiveTitle: "Consultations Archive",
    consultationsArchiveSubtitle: "Browse consultations from a past period.",
    noArchivedConsultations: "No consultations for this period",
    ...
    generalStateSelectPlaceholder: "Select general state",
    generalStateOptionGood: "Good general condition",
    generalStateOptionImpaired: "Impaired",
    generalStateOptionFeverish: "Feverish",
    generalStateOptionAsthenic: "Asthenic",
    generalStateOptionEmaciated: "Emaciated",
    consciousnessField: "Consciousness",
    consciousnessSelectPlaceholder: "Select consciousness level",
    consciousnessOptionOriented: "Conscious, oriented",
    consciousnessOptionAlert: "Alert",
    consciousnessOptionDrowsy: "Drowsy",
    consciousnessOptionConfused: "Confused",
    consciousnessOptionComatose: "Comatose",
    hydrationField: "Hydration",
    hydrationSelectPlaceholder: "Select hydration status",
    hydrationOptionAdequate: "Adequate",
    hydrationOptionDryMucous: "Dry mucous membranes",
    hydrationOptionDehydrated: "Signs of dehydration",
    ...
    vitalsRecordedAtLabel: "Vitals taken at",
    dossierNumberFieldLabel: "File No.",
    assignedDoctorFieldLabel: "Assigned doctor",
    locationFieldLabel: "Location",
    painLevelNone: "No pain",
    painLevelMild: "Mild pain",
    painLevelModerate: "Moderate pain",
    painLevelSevere: "Severe pain",
    painLevelExtreme: "Worst pain",
    lastConsultationLabel: "Last consultation:",
    lastDoctorLabel: "Last doctor:",
    sessionActiveLabel: "Active clinical session",
    recentConsultationsFieldLabel: "Recent consultations",
    recentExamsFieldLabel: "Recent exams",
    pertinentHistoryFieldLabel: "Relevant history",
  },
  fr: {
    consultations: "Consultations",
    consultation: "Consultation",
    ...
    consultationsArchiveTitle: "Archives des consultations",
    consultationsArchiveSubtitle: "Consulter les consultations d'une période passée.",
    noArchivedConsultations: "Aucune consultation pour cette période",
    ...
    generalStateSelectPlaceholder: "Sélectionner l'état général",
    generalStateOptionGood: "Bon état général",
    generalStateOptionImpaired: "Altéré",
    generalStateOptionFeverish: "Fébrile",
    generalStateOptionAsthenic: "Asthénique",
    generalStateOptionEmaciated: "Amaigri",
    consciousnessField: "Conscience",
    consciousnessSelectPlaceholder: "Sélectionner le niveau de conscience",
    consciousnessOptionOriented: "Conscient, orienté",
    consciousnessOptionAlert: "Vigilant",
    consciousnessOptionDrowsy: "Somnolent",
    consciousnessOptionConfused: "Confus",
    consciousnessOptionComatose: "Coma",
    hydrationField: "Hydratation",
    hydrationSelectPlaceholder: "Sélectionner l'état d'hydratation",
    hydrationOptionAdequate: "Correcte",
    hydrationOptionDryMucous: "Muqueuses sèches",
    hydrationOptionDehydrated: "Signes de déshydratation",
    ...
    stepProgressLabel: "Étape {current}/{total}",
    vitalsRecordedAtLabel: "Prise des constantes à",
    dossierNumberFieldLabel: "N° Dossier",
    assignedDoctorFieldLabel: "Médecin assigné",
    locationFieldLabel: "Emplacement",
    painLevelNone: "Aucune douleur",
    painLevelMild: "Douleur légère",
    painLevelModerate: "Douleur modérée",
    painLevelSevere: "Douleur sévère",
    painLevelExtreme: "Douleur maximale",
    lastConsultationLabel: "Dernière consultation :",
    lastDoctorLabel: "Dernier médecin :",
    sessionActiveLabel: "Session clinique active",
    recentConsultationsFieldLabel: "Dernières consultations",
    recentExamsFieldLabel: "Derniers examens",
    pertinentHistoryFieldLabel: "Antécédents pertinents",
  },
};
